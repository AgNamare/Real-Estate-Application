...
export default function ListingItem({ listing }) {
  return (
    <div className=" w-[300px] bg-white shadow-md hover:shadow-lg transition-shadow overflow-hidden rounded-lg">
      <Link to={`/listing/${listing._id}`}>
        ...
        <div className="p-3 flex flex-col gap-2 w-full">
          <p className="truncate w-full sm:w-{330px] text-lg font-semibold text-slate-700">{listing.name}</p>
